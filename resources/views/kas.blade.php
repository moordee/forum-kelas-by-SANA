    ...
    <div class="d-flex flex-grow-1">
        ...
        <main class="p-4 flex-grow-1">
            ...
            <nav class="navbar bg-body-tertiary">
                <form class="container" method="GET" action="{{ route('kas.index') }}">
                    <div class="input-group">
                        <span class="input-group-text" id="basic-addon1"><img src="images/Search.png"
                                width="20"></span>
                        <input type="search" name="q" class="form-control" placeholder="Cari Nama Siswa"
                            aria-label="nama-siswa" aria-describedby="basic-addon1" value="{{ request('q') }}" />
                    </div>
                </form>
            </nav>

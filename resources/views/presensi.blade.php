            ...
            <td class="text-center">
                <div class="d-flex justify-content-center gap-4">
                    <label class="form-check-inline">
                        <input class="form-check-input" type="radio" name="presensi{{ $item->nama_lengkap }}" value="H" {{ $isHadir === 'H' ? 'checked' : '' }}> H
                    </label>
                    <label class="form-check-inline">
                        <input class="form-check-input" type="radio" name="presensi{{ $item->nama_lengkap }}" value="A" {{ $isHadir === 'T' ? 'checked' : '' }}> A
                    </label>
                    <label class="form-check-inline">
                        <input class="form-check-input" type="radio" name="presensi{{ $item->nama_lengkap }}" value="S" {{ $isHadir === 'S' ? 'checked' : '' }}> S
                    </label>
                    <label class="form-check-inline">
                        <input class="form-check-input" type="radio" name="presensi{{ $item->nama_lengkap }}" value="I" {{ $isHadir === 'I' ? 'checked' : '' }}> I
                    </label>
                    <label class="form-check-inline">
                        <input class="form-check-input" type="radio" name="presensi{{ $item->nama_lengkap }}" value="D" {{ $isHadir === 'D' ? 'checked' : '' }}> D
                    </label>
                </div>
            </td>
        </tr>

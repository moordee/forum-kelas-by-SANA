                ...
                <table class="table table-bordered table-striped w-100 mt-4">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>A ndxhcdrrbfvbtrgfrf</td>
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-4">
                                    <label class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="presensi1" value="H"> H
                                    </label>
                                    <label class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="presensi1" value="A"> A
                                    </label>
                                    <label class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="presensi1" value="S"> S
                                    </label>
                                    <label class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="presensi1" value="D"> D
                                    </label>
                                </div>
                            </td>
                        </tr>
